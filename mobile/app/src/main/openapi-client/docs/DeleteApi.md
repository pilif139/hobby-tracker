...
|------------- | ------------- | -------------|
| [**deleteHobbySessionById**](DeleteApi.md#deleteHobbySessionById) | **DELETE** /hobby-session/{id} |  |
| [**deleteUserById**](DeleteApi.md#deleteUserById) | **DELETE** /user/{id} |  |
...
import com.filip.hobbytracker.api.generated.api.DeleteApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling DeleteApi#deleteHobbySessionById");
